...
public class ProductTable extends DalSetTableHelper<Product> {
    ...
    public ProductTable(Connection conn, String roleName) {
        super(conn, roleName);
    }
...
//                return new ProductTable(connection, roleName).queryProduct(option);
//            }
//        }.query();
//    }
//
...
//                new ProductTable(getConnection(), roleName).addProduct(product);
//            }
//
//            @Override
...
//            @Override
//            public void onUpdate() throws ErrorInfo, Exception {
//                new ProductTable(getConnection(), roleName).updateProduct(product);
//            }
//
//            @Override
//            public Product getResult() {
