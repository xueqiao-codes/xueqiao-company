...
public class ServiceMaintenance implements org.apache.thrift.TBase<ServiceMaintenance, ServiceMaintenance._Fields>, java.io.Serializable, Cloneable, Comparable<ServiceMaintenance> {
  ...
  private _Fields optionals[] = {_Fields.COMPANY_ID,_Fields.MAINTENANCE_TIME_SPAN,_Fields.MAINTENANCE_STATE,_Fields.VERSION_ID,_Fields.VERSION_TAG,_Fields.CREATE_TIMESTAMP,_Fields.LAST_MODIFY_TIMESTAMP};
   ...
   * @see MaintenanceTimeSpan
   */
  public ServiceMaintenance setMaintenanceTimeSpan(MaintenanceTimeSpan maintenanceTimeSpan) {
