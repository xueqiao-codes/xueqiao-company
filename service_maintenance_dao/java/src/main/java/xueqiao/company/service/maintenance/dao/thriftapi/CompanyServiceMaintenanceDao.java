              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.SET) {
                {
                  ...
                  struct.companyIds = new HashSet<Long>(2*_set48.size);
                  for (int _i49 = 0; _i49 < _set48.size; ++_i49)
                  {
                    long _elem50;
                    _elem50 = iprot.readI64();
                    struct.companyIds.add(_elem50);
                  }
                  iprot.readSetEnd();
                }
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, reqMaintenanceHistory_args struct) throws org.apache.thrift.TException {
        ...
        if (struct.companyIds != null) {
          oprot.writeFieldBegin(COMPANY_IDS_FIELD_DESC);
          {
            ...
            for (long _iter51 : struct.companyIds)
            {
        ...
        if (struct.isSetCompanyIds()) {
          {
            ...
            for (long _iter52 : struct.companyIds)
            {
        ...
        if (incoming.get(1)) {
          {
            ...
            struct.companyIds = new HashSet<Long>(2*_set53.size);
            for (int _i54 = 0; _i54 < _set53.size; ++_i54)
            {
              long _elem55;
              _elem55 = iprot.readI64();
              struct.companyIds.add(_elem55);
            }
          }
          struct.setCompanyIdsIsSet(true);
        }
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.success = new ArrayList<xueqiao.company.service.maintenance.MaintenanceHistory>(_list56.size);
                  for (int _i57 = 0; _i57 < _list56.size; ++_i57)
                  {
                    xueqiao.company.service.maintenance.MaintenanceHistory _elem58;
                    _elem58 = new xueqiao.company.service.maintenance.MaintenanceHistory();
                    _elem58.read(iprot);
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, reqMaintenanceHistory_result struct) throws org.apache.thrift.TException {
        ...
        if (struct.success != null) {
          oprot.writeFieldBegin(SUCCESS_FIELD_DESC);
          {
            ...
            for (xueqiao.company.service.maintenance.MaintenanceHistory _iter59 : struct.success)
            {
              _iter59.write(oprot);
            }
            oprot.writeListEnd();
        ...
        if (struct.isSetSuccess()) {
          {
            ...
            for (xueqiao.company.service.maintenance.MaintenanceHistory _iter60 : struct.success)
            {
              _iter60.write(oprot);
            }
          }
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.success = new ArrayList<xueqiao.company.service.maintenance.MaintenanceHistory>(_list61.size);
            for (int _i62 = 0; _i62 < _list61.size; ++_i62)
            {
              xueqiao.company.service.maintenance.MaintenanceHistory _elem63;
              _elem63 = new xueqiao.company.service.maintenance.MaintenanceHistory();
              _elem63.read(iprot);
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.details = new ArrayList<xueqiao.company.service.maintenance.ScheduleOperateDetail>(_list64.size);
                  for (int _i65 = 0; _i65 < _list64.size; ++_i65)
                  {
                    xueqiao.company.service.maintenance.ScheduleOperateDetail _elem66;
                    _elem66 = new xueqiao.company.service.maintenance.ScheduleOperateDetail();
                    _elem66.read(iprot);
                    struct.details.add(_elem66);
                  }
                  iprot.readListEnd();
                }
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, addScheduleOperateDetail_args struct) throws org.apache.thrift.TException {
        ...
        if (struct.details != null) {
          oprot.writeFieldBegin(DETAILS_FIELD_DESC);
          {
            ...
            for (xueqiao.company.service.maintenance.ScheduleOperateDetail _iter67 : struct.details)
            {
              _iter67.write(oprot);
            }
            oprot.writeListEnd();
        ...
        if (struct.isSetDetails()) {
          {
            ...
            for (xueqiao.company.service.maintenance.ScheduleOperateDetail _iter68 : struct.details)
            {
              _iter68.write(oprot);
            }
          }
        ...
        if (incoming.get(1)) {
          {
            ...
            struct.details = new ArrayList<xueqiao.company.service.maintenance.ScheduleOperateDetail>(_list69.size);
            for (int _i70 = 0; _i70 < _list69.size; ++_i70)
            {
              xueqiao.company.service.maintenance.ScheduleOperateDetail _elem71;
              _elem71 = new xueqiao.company.service.maintenance.ScheduleOperateDetail();
              _elem71.read(iprot);
              struct.details.add(_elem71);
            }
          }
          struct.setDetailsIsSet(true);
        }
    ...
    private static class reqScheduleOperateDetail_resultStandardScheme extends StandardScheme<reqScheduleOperateDetail_result> {
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.success = new ArrayList<xueqiao.company.service.maintenance.ScheduleOperateDetail>(_list72.size);
                  for (int _i73 = 0; _i73 < _list72.size; ++_i73)
                  {
                    xueqiao.company.service.maintenance.ScheduleOperateDetail _elem74;
                    _elem74 = new xueqiao.company.service.maintenance.ScheduleOperateDetail();
                    _elem74.read(iprot);
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, reqScheduleOperateDetail_result struct) throws org.apache.thrift.TException {
        ...
        if (struct.success != null) {
          ...
          {
            oprot.writeListBegin(new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, struct.success.size()));
            for (xueqiao.company.service.maintenance.ScheduleOperateDetail _iter75 : struct.success)
            {
              _iter75.write(oprot);
            }
            oprot.writeListEnd();
    ...
    private static class reqScheduleOperateDetail_resultTupleScheme extends TupleScheme<reqScheduleOperateDetail_result> {
      ...
      public void write(org.apache.thrift.protocol.TProtocol prot, reqScheduleOperateDetail_result struct) throws org.apache.thrift.TException {
        ...
        if (struct.isSetSuccess()) {
          {
            oprot.writeI32(struct.success.size());
            for (xueqiao.company.service.maintenance.ScheduleOperateDetail _iter76 : struct.success)
            {
              _iter76.write(oprot);
            }
          }
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.success = new ArrayList<xueqiao.company.service.maintenance.ScheduleOperateDetail>(_list77.size);
            for (int _i78 = 0; _i78 < _list77.size; ++_i78)
            {
              xueqiao.company.service.maintenance.ScheduleOperateDetail _elem79;
              _elem79 = new xueqiao.company.service.maintenance.ScheduleOperateDetail();
              _elem79.read(iprot);
