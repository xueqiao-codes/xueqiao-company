            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.SET) {
              {
                ...
                struct.companyIds = new HashSet<Long>(2*_set16.size);
                for (int _i17 = 0; _i17 < _set16.size; ++_i17)
                {
                  long _elem18;
                  _elem18 = iprot.readI64();
                  struct.companyIds.add(_elem18);
                }
                iprot.readSetEnd();
              }
      ...
      if (struct.companyIds != null) {
        if (struct.isSetCompanyIds()) {
          oprot.writeFieldBegin(COMPANY_IDS_FIELD_DESC);
          {
            ...
            for (long _iter19 : struct.companyIds)
            {
      ...
      if (struct.isSetCompanyIds()) {
        {
          ...
          for (long _iter20 : struct.companyIds)
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.companyIds = new HashSet<Long>(2*_set21.size);
          for (int _i22 = 0; _i22 < _set21.size; ++_i22)
          {
            long _elem23;
            _elem23 = iprot.readI64();
            struct.companyIds.add(_elem23);
          }
        }
        struct.setCompanyIdsIsSet(true);
      }
