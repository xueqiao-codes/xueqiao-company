...
public class ErrorCode {
    ...
    public static ErrorInfo HostingRelatedInfoNotFoundErrorInfo = new ErrorInfo(1320, "HostingRelatedInfo not found.");

    public static ErrorInfo CompanyGroupNotFoundErrorInfo = new ErrorInfo(1321, "CompanyGroup not found.");
}
