            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.page = new ArrayList<CompanyUser>(_list56.size);
                for (int _i57 = 0; _i57 < _list56.size; ++_i57)
                {
                  CompanyUser _elem58;
                  _elem58 = new CompanyUser();
                  _elem58.read(iprot);
      ...
      if (struct.page != null) {
        if (struct.isSetPage()) {
          oprot.writeFieldBegin(PAGE_FIELD_DESC);
          {
            ...
            for (CompanyUser _iter59 : struct.page)
            {
              _iter59.write(oprot);
            }
            oprot.writeListEnd();
      ...
      if (struct.isSetPage()) {
        {
          ...
          for (CompanyUser _iter60 : struct.page)
          {
            _iter60.write(oprot);
          }
        }
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.page = new ArrayList<CompanyUser>(_list61.size);
          for (int _i62 = 0; _i62 < _list61.size; ++_i62)
          {
            CompanyUser _elem63;
            _elem63 = new CompanyUser();
            _elem63.read(iprot);
