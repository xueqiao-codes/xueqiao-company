...
public class QueryCompanyUserOption implements org.apache.thrift.TBase<QueryCompanyUserOption, QueryCompanyUserOption._Fields>, java.io.Serializable, Cloneable, Comparable<QueryCompanyUserOption> {
  ...
  private _Fields optionals[] = {_Fields.COMPANY_ID,_Fields.USER_ID,_Fields.USER_NAME,_Fields.STATUS};
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.SET) {
              {
                ...
                struct.userId = new HashSet<Integer>(2*_set40.size);
                for (int _i41 = 0; _i41 < _set40.size; ++_i41)
                {
                  int _elem42;
                  _elem42 = iprot.readI32();
                  struct.userId.add(_elem42);
                }
                iprot.readSetEnd();
              }
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.userId = new HashSet<Integer>(2*_set45.size);
          for (int _i46 = 0; _i46 < _set45.size; ++_i46)
          {
            int _elem47;
            _elem47 = iprot.readI32();
            struct.userId.add(_elem47);
          }
        }
        struct.setUserIdIsSet(true);
      }
