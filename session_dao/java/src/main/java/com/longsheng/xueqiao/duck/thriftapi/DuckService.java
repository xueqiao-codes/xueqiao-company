              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.sessionKeyList = new ArrayList<String>(_list0.size);
                  for (int _i1 = 0; _i1 < _list0.size; ++_i1)
                  {
                    String _elem2;
                    _elem2 = iprot.readString();
                    struct.sessionKeyList.add(_elem2);
                  }
                  iprot.readListEnd();
                }
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, batchGetSession_args struct) throws org.apache.thrift.TException {
        ...
        if (struct.sessionKeyList != null) {
          oprot.writeFieldBegin(SESSION_KEY_LIST_FIELD_DESC);
          {
            ...
            for (String _iter3 : struct.sessionKeyList)
            {
        ...
        if (struct.isSetSessionKeyList()) {
          {
            ...
            for (String _iter4 : struct.sessionKeyList)
            {
        ...
        if (incoming.get(1)) {
          {
            ...
            struct.sessionKeyList = new ArrayList<String>(_list5.size);
            for (int _i6 = 0; _i6 < _list5.size; ++_i6)
            {
              String _elem7;
              _elem7 = iprot.readString();
              struct.sessionKeyList.add(_elem7);
            }
          }
          struct.setSessionKeyListIsSet(true);
        }
