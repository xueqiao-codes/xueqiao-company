...
public class HostingRelatedInfoTable extends DalSetTableHelper<HostingRelatedInfo> {
	...
	public long addRelatedInfo(IdMaker relatedIdMaker, HostingRelatedInfo relatedInfo) 
			throws IdException, SQLException {
		long relatedId = relatedIdMaker.createId();
	...
	public HostingRelatedInfoPageResult queryRelatedInfoPage(
			QueryHostingRelatedInfoOption option
