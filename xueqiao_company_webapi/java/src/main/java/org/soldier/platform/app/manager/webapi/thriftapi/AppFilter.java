 ...
 * 预留filter做为筛选的条件
 */
public class AppFilter implements org.apache.thrift.TBase<AppFilter, AppFilter._Fields>, java.io.Serializable, Cloneable, Comparable<AppFilter> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("AppFilter");
  ...
  private static final org.apache.thrift.protocol.TField OS_PLATFORM_FIELD_DESC = new org.apache.thrift.protocol.TField("osPlatform", org.apache.thrift.protocol.TType.I32, (short)3);
  private static final org.apache.thrift.protocol.TField APP_NAME_PARTICAL_FIELD_DESC = new org.apache.thrift.protocol.TField("appNamePartical", org.apache.thrift.protocol.TType.STRING, (short)4);

  private static final Map<Class<? extends IScheme>, SchemeFactory> schemes = new HashMap<Class<? extends IScheme>, SchemeFactory>();
  static {
    schemes.put(StandardScheme.class, new AppFilterStandardSchemeFactory());
    schemes.put(TupleScheme.class, new AppFilterTupleSchemeFactory());
  }
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
     ...
     * @see org.soldier.platform.app.manager.thriftapi.OSPlatform
     */
    OS_PLATFORM((short)3, "osPlatform"),
    APP_NAME_PARTICAL((short)4, "appNamePartical");
  ...
  private _Fields optionals[] = {_Fields.APP_TYPE,_Fields.PROJECT_ID,_Fields.OS_PLATFORM,_Fields.APP_NAME_PARTICAL};
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(AppFilter.class, metaDataMap);
  }
   ...
   */
  public AppFilter(AppFilter other) {
   ...
   * @see org.soldier.platform.app.manager.thriftapi.AppType
   */
  public AppFilter setAppType(org.soldier.platform.app.manager.thriftapi.AppType appType) {
  ...
  public AppFilter setProjectId(long projectId) {
   ...
   * @see org.soldier.platform.app.manager.thriftapi.OSPlatform
   */
  public AppFilter setOsPlatform(org.soldier.platform.app.manager.thriftapi.OSPlatform osPlatform) {
  ...
  public AppFilter setAppNamePartical(String appNamePartical) {
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof AppFilter)
      return this.equals((AppFilter)that);
    return false;
  }

  public boolean equals(AppFilter that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(AppFilter other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("AppFilter(");
    boolean first = true;
  ...
  private static class AppFilterStandardSchemeFactory implements SchemeFactory {
    public AppFilterStandardScheme getScheme() {
      return new AppFilterStandardScheme();
    }
  }

  private static class AppFilterStandardScheme extends StandardScheme<AppFilter> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, AppFilter struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, AppFilter struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class AppFilterTupleSchemeFactory implements SchemeFactory {
    public AppFilterTupleScheme getScheme() {
      return new AppFilterTupleScheme();
    }
  }

  private static class AppFilterTupleScheme extends TupleScheme<AppFilter> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, AppFilter struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, AppFilter struct) throws org.apache.thrift.TException {
