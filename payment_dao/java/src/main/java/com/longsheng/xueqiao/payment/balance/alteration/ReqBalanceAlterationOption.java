            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.SET) {
              {
                ...
                struct.alterationIds = new HashSet<Long>(2*_set0.size);
                for (int _i1 = 0; _i1 < _set0.size; ++_i1)
                {
                  long _elem2;
                  _elem2 = iprot.readI64();
                  struct.alterationIds.add(_elem2);
                }
                iprot.readSetEnd();
              }
      ...
      if (struct.alterationIds != null) {
        if (struct.isSetAlterationIds()) {
          oprot.writeFieldBegin(ALTERATION_IDS_FIELD_DESC);
          {
            ...
            for (long _iter3 : struct.alterationIds)
            {
      ...
      if (struct.isSetAlterationIds()) {
        {
          ...
          for (long _iter4 : struct.alterationIds)
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.alterationIds = new HashSet<Long>(2*_set5.size);
          for (int _i6 = 0; _i6 < _set5.size; ++_i6)
          {
            long _elem7;
            _elem7 = iprot.readI64();
            struct.alterationIds.add(_elem7);
          }
        }
        struct.setAlterationIdsIsSet(true);
      }
